...
The screenshot below shows a real post produced by the workflow — RSS ingestion, Writer–Critic refinement, and publication through the Twitter publisher adapter.

![Example post generated by the workflow](docs/screenshot.png)
